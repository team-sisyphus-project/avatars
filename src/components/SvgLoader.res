...
let getMouthBigsmile = (fill, size) =>
  `<svg width="${size}" height="${size}" viewBox="0 0 64 64"><path fill="${fill}" d="M29 38h6v1a3 3 0 0 1-6 0z"/></svg>`
let getMouthFrown = (fill, size) =>
  `<svg width="${size}" height="${size}" viewBox="0 0 64 64"><path fill="${fill}" d="M28.004 40.132a1 1 0 0 0 .992 1.736C30.016 41.285 31.014 41 32 41s1.983.285 3.004.868a1 1 0 1 0 .992-1.736C34.684 39.382 33.348 39 32 39c-1.348 0-2.684.382-3.996 1.132z"/></svg>`
let getMouthLips = (fill, size) =>
  `<svg fill="${fill}" width="${size}" height="${size}" viewBox="0 0 64 64"><g fill="none"><path fill="#dc5c7a" d="M28 41h8c-.667 1.667-2 2.5-4 2.5s-3.333-.833-4-2.5z"/><path fill="#f57b98" d="M32 40a2.092 2.092 0 0 1 3.612.225L36 41h-8l.388-.775A2.092 2.092 0 0 1 32 40z"/></g></svg>`
let getMouthPacifier = (fill, size) =>
...
let getMouthSmile = (fill, size) =>
  `<svg width="${size}" height="${size}" viewBox="0 0 64 64"><path fill="${fill}" d="M28.004 41.868a1 1 0 0 1 .992-1.736c1.02.583 2.018.868 3.004.868s1.983-.285 3.004-.868a1 1 0 1 1 .992 1.736C34.684 42.618 33.348 43 32 43c-1.348 0-2.684-.382-3.996-1.132z"/></svg>`
let getMouthSmirk = (fill, size) =>
  `<svg width="${size}" height="${size}" viewBox="0 0 64 64"><path fill="${fill}" d="M30.318 41.728a.75.75 0 0 1 .364-1.456c2.433.609 4.165.32 5.288-.802a.75.75 0 0 1 1.06 1.06c-1.544 1.545-3.812 1.923-6.712 1.198z"/></svg>`
let getMouthSurprise = (fill, size) =>
  `<svg width="${size}" height="${size}" viewBox="0 0 64 64"><ellipse cx="32" cy="41" fill="${fill}" rx="2" ry="2.5"/></svg>`
...
let getEyesDizzy = (fill, size) =>
  `<svg fill="${fill}" width="${size}" height="${size}" viewBox="0 0 64 64"><g stroke="#1b0640" stroke-width="1.5" stroke-linecap="round"><path d="m24 27 3.5 3.5m0-3.5L24 30.5m10.5-3.5 3.5 3.5m0-3.5-3.5 3.5"/></g></svg>`

let getEyesSideeye = (fill, size) =>
  `<svg width="${size}" height="${size}" viewBox="0 0 64 64"><g fill="none"><path fill="#fff" d="M28.5 28.5a3 3 0 1 1-6 0 3 3 0 0 1 6 0zm13 0a3 3 0 1 1-6 0 3 3 0 0 1 6 0z"/><path fill="${fill}" d="M28.4 28.5a1.5 1.5 0 1 1-3 0 1.5 1.5 0 0 1 3 0zm13 0a1.5 1.5 0 1 1-3 0 1.5 1.5 0 0 1 3 0z"/></g></svg>`

/* --- 2026 expansion: mouths --- */

let getMouthGrin = (fill, size) =>
  `<svg width="${size}" height="${size}" viewBox="0 0 64 64"><g fill="none"><path fill="${fill}" d="M26.5 38.5h11a5.5 5.5 0 0 1-11 0z"/><path fill="#fff" d="M27.6 39.5h8.8v.8a1.4 1.4 0 0 1-1.4 1.4h-6a1.4 1.4 0 0 1-1.4-1.4z"/></g></svg>`

let getMouthTongue = (fill, size) =>
  `<svg width="${size}" height="${size}" viewBox="0 0 64 64"><g fill="none"><path fill="${fill}" d="M28.004 39.868a1 1 0 0 1 .992-1.736c1.02.583 2.018.868 3.004.868s1.983-.285 3.004-.868a1 1 0 1 1 .992 1.736C34.684 40.618 33.348 41 32 41c-1.348 0-2.684-.382-3.996-1.132z"/><path fill="#f57b98" d="M30 40.6c.66.27 1.33.4 2 .4s1.34-.13 2-.4v1.4a2 2 0 0 1-4 0z"/></g></svg>`

let getMouthWhistle = (fill, size) =>
  `<svg width="${size}" height="${size}" viewBox="0 0 64 64"><ellipse fill="${fill}" cx="33" cy="40.3" rx="1.7" ry="2.1"/></svg>`

let getMouthLaugh = (fill, size) =>
  `<svg width="${size}" height="${size}" viewBox="0 0 64 64"><g fill="none"><path fill="${fill}" d="M27 38h10c0 3.6-2.2 6-5 6s-5-2.4-5-6z"/><path fill="#f57b98" d="M29.3 42.8c.76.76 1.68 1.2 2.7 1.2s1.94-.44 2.7-1.2c-.7-.95-1.63-1.5-2.7-1.5s-2 .55-2.7 1.5z"/></g></svg>`
